...
# ---------------------------------------------------------------------------
# HazardOverview.py
# Created on: 2017-06-13 16:41:52.00000
#   (generated by ArcGIS/ModelBuilder)
# Description: This script creates the "Hazard Overview" shapefiles from
#   USGS ShakeMap GIS data at county, tract and block level. (Max MI per
#   geographic boundary)
...
ShakeMapDir = arcpy.GetParameterAsText(0)
mi = "{}\mi.shp".format(ShakeMapDir)
pgv = "{}\pgv.shp".format(ShakeMapDir)
pga = "{}\pga.shp".format(ShakeMapDir)

#Census Geographies
Blocks = r"\\hqmac3f1\Static\GISdata\ESRI\2017\usa\census\blkgrp.gdb\blkgrp"
Tracts = r"\\hqmac3f1\Static\GISdata\ESRI\2017\usa\census\tracts.gdb\tracts"
Counties = r"\\hqmac3f1\Static\GISdata\ESRI\2017\usa\census\dtl_cnty.gdb\dtl_cnty"
