...
def join_seis_code(JoinFrom_features, JoinTo_features, ToField):
    ...
    arcpy.MakeFeatureLayer_management(in_features=JoinFrom_features, out_layer="JoinFrom_Lyr")
    arcpy.MakeFeatureLayer_management(in_features=JoinTo_features, out_layer="JoinTo_Lyr")
